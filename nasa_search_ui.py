...
class MainPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        txt_2 = 'Example: moon landing'
        label_2 = wx.StaticText(self, label=txt_2)
        main_sizer.Add(label, 0, wx.ALL, 5)
        main_sizer.Add(label_2, 0, wx.ALL, 5)
        self.search = wx.SearchCtrl(self, style=wx.TE_PROCESS_ENTER, size=(-1, 10))
